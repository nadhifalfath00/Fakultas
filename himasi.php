                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <i class="fas fa-book-open me-2"></i> Visi Himpunanan Mahasiswa Sistem Informasi
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <i class="fas fa-user-graduate me-2"></i> Misi Himpunanan Mahasiswa Sistem Informasi
                            </button>
                        </h2>
